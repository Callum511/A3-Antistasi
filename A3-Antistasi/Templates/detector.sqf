...
isClass (configfile >> "CfgPatches" >> "hlcweapons_AUG") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_ar15") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_G36") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_m14") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_falpocalypse") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_aks") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_acr") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_FHAWCovert") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_FN3011") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_g3") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_M134") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_m60e4") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_MG3s") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_mp5") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_SAW") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_SG550") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_Springfield1903") &&
isClass (configfile >> "CfgPatches" >> "hlcweapons_stgw57") &&
isClass (configfile >> "CfgPatches" >> "niaweapons_226") &&
isClass (configfile >> "CfgPatches" >> "niarms_416") &&
isClass (configfile >> "CfgPatches" >> "niaweapons_C96")
) then {
  A3A_hasNIA = true;
  [2,"NIA Detected.",_fileName] call A3A_fnc_log;
};
...
if (!A3A_hasRHS && !A3A_hasFFAA && !A3A_hasIFA && !A3A_has3CBBAF && !A3A_hasNIA) then {[2,"No Side Replacement Mods Detected.",_fileName] call A3A_fnc_log;};
