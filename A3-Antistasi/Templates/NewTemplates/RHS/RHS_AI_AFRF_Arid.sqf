...
_sfLoadoutData setVariable ["uniforms", ["rhs_uniform_6sh122_gloves_v2"]];			//this line determines uniforms for special forces -- Example: ["U_B_CombatUniform_mcam", "U_B_CombatUniform_mcam_tshirt"] -- Array, can contain multiple assets
...
_militiaLoadoutData setVariable ["uniforms", ["rhs_uniform_afghanka_para"]];
...
_militiaLoadoutData setVariable ["helmets", ["rhs_fieldcap_m88", "rhs_fieldcap_m88_back"]];
