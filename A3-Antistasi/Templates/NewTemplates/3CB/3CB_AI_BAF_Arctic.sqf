...
["uavsAttack", ["UK3CB_BAF_MQ9_Reaper_DDPM"]] call _fnc_saveToTemplate; 				//this line determines attack UAVs -- Example: ["uavsAttack", ["B_UAV_02_CAS_F"]] -- Array, can contain multiple assets
...
_sfLoadoutData setVariable ["uniforms", ["UK3CB_BAF_U_Smock_MTP_Arctic"]];			//this line determines uniforms for special forces -- Example: ["U_B_CombatUniform_mcam", "U_B_CombatUniform_mcam_tshirt"] -- Array, can contain multiple assets
...
_sfLoadoutData setVariable ["backpacks", ["UK3CB_BAF_B_Kitbag_Arctic", "UK3CB_BAF_B_Carryall_Arctic", "UK3CB_BAF_B_Bergen_Arctic_Rifleman_A", "UK3CB_BAF_B_Bergen_Arctic_Rifleman_B"]];
_sfLoadoutData setVariable ["AAbackpacks", ["UK3CB_BAF_B_Carryall_Arctic"]];
...
_militaryLoadoutData setVariable ["uniforms", ["UK3CB_BAF_U_Smock_Arctic"]];
_militaryLoadoutData setVariable ["vests", ["UK3CB_BAF_V_Osprey_Winter"]];
_militaryLoadoutData setVariable ["backpacks", ["UK3CB_BAF_B_Kitbag_Arctic", "UK3CB_BAF_B_Bergen_Arctic_Rifleman_A", "UK3CB_BAF_B_Bergen_Arctic_Rifleman_B"]];
_militaryLoadoutData setVariable ["AAbackpacks", ["UK3CB_BAF_B_Carryall_Arctic"]];
_militaryLoadoutData setVariable ["helmets", ["UK3CB_BAF_H_Mk7_Win_A", "UK3CB_BAF_H_Mk7_Win_ESS_A"]];		//this line determines helmets for military loadouts -- Example: ["H_HelmetB_camo", "H_HelmetB_desert"] -- Array, can contain multiple assets
...
_militiaLoadoutData setVariable ["uniforms", ["UK3CB_BAF_U_Smock_DPMW_Arctic"]];		//this line determines uniforms for militia loadouts -- Example: ["U_B_CombatUniform_mcam", "U_B_CombatUniform_mcam_tshirt"] -- Array, can contain multiple assets
_militiaLoadoutData setVariable ["vests", ["UK3CB_BAF_V_PLCE_Webbing_Winter"]];			//this line determines vests for militia loadouts -- Example: ["V_PlateCarrierSpec_mtp", "V_PlateCarrierGL_mtp"] -- Array, can contain multiple assets
_militiaLoadoutData setVariable ["backpacks", ["UK3CB_BAF_B_Kitbag_Arctic", "UK3CB_BAF_B_Carryall_Arctic", "UK3CB_BAF_B_Bergen_Arctic_Rifleman_A", "UK3CB_BAF_B_Bergen_Arctic_Rifleman_B"]];		//this line determines backpacks for militia loadouts -- Example: ["B_AssaultPack_mcamo", "B_Kitbag_mcamo"] -- Array, can contain multiple assets
...
_pilotLoadoutData setVariable ["vests", ["UK3CB_BAF_V_Osprey_Winter"]];			//this line determines vests for pilot loadouts -- Example: ["V_PlateCarrierSpec_mtp", "V_PlateCarrierGL_mtp"] -- Array, can contain multiple assets
