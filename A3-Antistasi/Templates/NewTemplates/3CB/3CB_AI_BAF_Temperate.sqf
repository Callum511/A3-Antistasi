...
_militaryLoadoutData setVariable ["uniforms", ["UK3CB_BAF_U_CombatUniform_DPMT", "UK3CB_BAF_U_CombatUniform_DPMT_ShortSleeve"]];
_militaryLoadoutData setVariable ["vests", ["UK3CB_BAF_V_Osprey_DPMT7"]];
_militaryLoadoutData setVariable ["SLvests", ["UK3CB_BAF_V_Osprey_DPMT2"]];
_militaryLoadoutData setVariable ["MEDvests", ["UK3CB_BAF_V_Osprey_DPMT8", "UK3CB_BAF_V_Osprey_DPMT9"]];
_militaryLoadoutData setVariable ["GLvests", ["UK3CB_BAF_V_Osprey_DPMT3"]];
_militaryLoadoutData setVariable ["backpacks", ["UK3CB_BAF_B_Kitbag_DPMT", "UK3CB_BAF_B_Bergen_DPMT_Rifleman_A",
"UK3CB_BAF_B_Bergen_DPMT_Rifleman_B"]];
_militaryLoadoutData setVariable ["AAbackpacks", ["UK3CB_BAF_B_Carryall_DPMT"]];
_militaryLoadoutData setVariable ["helmets", ["UK3CB_BAF_H_Mk6_DPMT_D", "UK3CB_BAF_H_Mk6_DPMT_F", "UK3CB_BAF_H_Mk6_DPMT_B", "UK3CB_BAF_H_Mk6_DPMT_A"]];		//this line determines helmets for military loadouts -- Example: ["H_HelmetB_camo", "H_HelmetB_desert"] -- Array, can contain multiple assets
...
_militiaLoadoutData setVariable ["uniforms", ["UK3CB_BAF_U_Smock_DPMT"]];		//this line determines uniforms for militia loadouts -- Example: ["U_B_CombatUniform_mcam", "U_B_CombatUniform_mcam_tshirt"] -- Array, can contain multiple assets
_militiaLoadoutData setVariable ["vests", ["UK3CB_BAF_V_PLCE_Webbing_DPMT"]];			//this line determines vests for militia loadouts -- Example: ["V_PlateCarrierSpec_mtp", "V_PlateCarrierGL_mtp"] -- Array, can contain multiple assets
...
_crewLoadoutData setVariable ["uniforms", ["UK3CB_BAF_U_CombatUniform_DPMT"]];			//this line determines uniforms for vehicle crew loadouts -- Example: ["U_B_CombatUniform_mcam", "U_B_CombatUniform_mcam_tshirt"] -- Array, can contain multiple assets
_crewLoadoutData setVariable ["vests", ["UK3CB_BAF_V_Osprey_DPMT1"]];				//this line determines vests for vehicle crew loadouts -- Example: ["V_PlateCarrierSpec_mtp", "V_PlateCarrierGL_mtp"] -- Array, can contain multiple assets
...
_pilotLoadoutData setVariable ["vests", ["UK3CB_BAF_V_Pilot_DPMT"]];			//this line determines vests for pilot loadouts -- Example: ["V_PlateCarrierSpec_mtp", "V_PlateCarrierGL_mtp"] -- Array, can contain multiple assets
